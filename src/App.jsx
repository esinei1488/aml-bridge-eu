...
const content = {
  ...
  ua: {
    ...
    heroText: "AML Bridge EU допомагає бізнесу та приватним клієнтам готувати структуровані AML-документи, відповідати банкам і криптобіржам, пояснювати походження коштів та покращувати compliance readiness.",
